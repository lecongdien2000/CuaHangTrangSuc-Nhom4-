...
<body style="">
	...
	<section id="cart_items">
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="order-message">
							<h3>Ghi chú</h3>
							<textarea name="message" placeholder="Ghi chú về đơn hàng của bạn, đặc biệt là cho người giao hàng." rows="16"></textarea>
			...
			<button class="payment-confirm">Xác nhận</button>
		</div>
	</section> <!--/#cart_items-->

...
<body>
	...
	<div class="container">
		<div class="content">
			<h2 style="margin-bottom: 45px;">Nhập tên tài khoản cần khôi phục</h2>
			<form action="passwordReset" method="post">
				<input type="text" name="username" class="inputTxt" placeholder="Username" style="padding-left: 10px">
